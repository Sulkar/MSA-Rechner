...
export default {
  ...
  watch: {
    gesamtnote(newValue, oldValue) {
      this.$emit("getFachNote", "nutNote", newValue);
    },
  },
  methods: {
...
<template>
  <div class="row">
    <div class="fach">NuT</div>
    <div class="notenfelderRow">
      <Notenfeld id="N1" nextId="I1" typ="jahresnote" @getNote="handleGetNote"></Notenfeld>
      <Notenplatzhalter width="100px;"></Notenplatzhalter>

      <Gesamtnote id="N2" :note="gesamtnote"></Gesamtnote>
